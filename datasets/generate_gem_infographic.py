...
def main() -> None:
    ...
    cv2.putText(
        canvas,
        "THE COLOR SIGNATURES OF BEJEWELED",
        (64, 78),
    ...
    cv2.putText(
        canvas,
        "Real gem crops + saturation-filtered HSV hue histograms",
        (67, 120),
    ...
    for index, name in enumerate(CLASSES):
        ...
        for bin_index, value in enumerate(histogram):
            ...
            cv2.rectangle(
                canvas, (x, baseline - bar_height), (x + bar_width - 2, baseline), color, -1
            )
        ...
        cv2.putText(
            canvas,
            "Facet highlights create secondary peaks.",
            (x0 + 25, y0 + 338),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.52,
            (205, 195, 210),
        ...
        cv2.putText(
            canvas,
            "The dominant hue family remains the clue.",
            (x0 + 25, y0 + 372),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.52,
            (205, 195, 210),
    ...
    cv2.putText(
        canvas,
        "VISION PIPELINE  /  CENTER BODY  /  SATURATION >= 90  /  18 HUE BINS",
        (65, 1180),
        cv2.FONT_HERSHEY_SIMPLEX,
        0.62,
        (140, 130, 150),
